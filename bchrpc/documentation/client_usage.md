...
1. Generate the language-specific client bindings using the `protoc` compiler and [bchrpc.proto](https://github.com/gcash/bchd/blob/master/bchrpc/bchrpc.proto)
